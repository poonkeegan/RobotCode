...
#pragma config(Motor,  port10,          intakeMotor2,  tmotorVex393_HBridge, openLoop)
...
task autonomous()
{
	...
	while (true)	//Creates an infinite loop
	{
		...
		displayNextLCDNumber(SensorValue(potLeft));    // display the reading.
		...
		displayNextLCDNumber(SensorValue(potRight));    // display the reading.
