...
task main(){
	...
	while(nMotorEncoder[backRight] > -600 && nMotorEncoder[backLeft] > -600){
		motor[backLeft] = -127;
		motor[backRight] = -127;
		motor[frontLeft] = -127;
		motor[frontRight] = -127;
	...
	while(abs(nMotorEncoder[backLeft]) < 1300 && abs(nMotorEncoder[backRight]) < 1300){
		motor[backLeft] =   100;
		motor[backRight] =  -100;
		motor[frontLeft] =  100;
	...
	while(SensorValue[potLeft] > 2729 || SensorValue[potRight] > 2495){
